...
public class Outlaw2 : MonoBehaviour
{
    // original scale is 1.4, 1.4, 1

    public float deadTimer = 0.05f; // how long after shot it disappears
    public static float spawnTimer = 1.25f; // how long it spawns for
    public int outlaw2Points = 3;
